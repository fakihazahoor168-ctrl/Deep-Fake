...
#     cnn_pred = predict(cnn_model, tensor)
#     eff_pred = predict(efficient_model, tensor)

#     st.subheader("🔍 Predictions")
#     st.write(f"**CNN Model:** {class_names[cnn_pred]}")
#     st.write(f"**EfficientNet-B3 Model:** {class_names[eff_pred]}")
